...
GRID_CONDITIONING_GIS_100FtSource = "Database Connections\\GRID_CONDITIONING.GIS.sde\\GRID_CONDITIONING.GIS.GRID_100FtBase"
...
try:
        arcpy.Clip_analysis(GRID_CONDITIONING_GIS_100FtSource, theExtentsLayer, GRID_CONDITIONING_GIS_BasicGrid + "_Clip", "0.1 Feet")
except:
