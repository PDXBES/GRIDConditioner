...
try:
    ...
    print(OutClassName + "Simplify.shp ready to be created")
arcpy.FeatureClassToFeatureClass_conversion(modules + "\\" + OutClassName + "Simplify.shp", GRID_CONDITIONING_GIS_sde, OutClassName + "_PreDissolve")
...
connStr = (r'DRIVER={SQL Server}; SERVER=' + server + ';DATABASE=' + database + ';' + 'UID=GIS;PWD=Hydr0plane')
